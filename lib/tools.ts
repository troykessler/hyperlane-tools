...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    title: "Hash Text",
    description:
      "Hash text strings using MD5, SHA1, SHA256, SHA224, SHA512, SHA384, SHA3, or RIPEMD160",
  ...
  },
  {
    ...
    description:
      "Generate random tokens with customizable length and character types",
  ...
  },
  {
    ...
    description:
      "Generate private keys and account addresses for different protocols",
